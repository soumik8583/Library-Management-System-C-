...
int main()
{
	...
	while (1)
    {
		...
		cout << "            "  << "-------------" << endl
          ...
          << "            "  << "( A ) Add Book" << endl << endl

          << "            " << "( O ) Sort all Books" << endl << endl

          << "            " << "( S ) Search all Books" << endl << endl

          << "            " << "( D ) Diplay all Books" << endl << endl

          << "            "  << "( T ) Delete a Book" << endl << endl

          << "            "<< "( M ) Update Book Information" << endl << endl
...
void display(void)
	{
		...
		cout<<"            " <<"\"Book ID\""<<"            " <<"\"Book Name\""<<"            " <<"\"Author Name\""<<"            " <<"\"Category\""<<"            " <<"\"Publication\""<<"            " <<"\"Month of Publication\""<<"            " <<"\"Year of Publication\""<<endl;
		cout<<"__________"<<"__________________________________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<endl;
		for(int i=0;i<n;i++)
			{
				cout<<"            " <<books[i].bookid<<"            " <<books[i].bookname<<"            " <<books[i].authorname<<"            " <<books[i].bookcategory<<"            " <<books[i].bookpubcom<<"            " <<books[i].bookpubmonth<<"            " <<books[i].bookpubyear<<endl;
				cout<<"__________"<<"__________________________________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<endl;
			}
...
void search(void)
	{
	   ...
	   cout <<"            " << "In Search Function"<<endl
          << "            "( 52 )<< "Please choose one of the options below: "
          ...
          << "            "( 46 ) << "( P ) Search by Publication Company" << endl << endl

          << "            "( 43 ) << "( Y ) Search by Publication Year" << endl << endl
          
		  <<"            "( 32 ) << "Enter Option      [ ]" << endl << endl;
			gotoxy(30,16);
...
void sbyname(void)
	{
		...
		for(int i = 0;i<n;i++)
		{
			if(strcmp(books[i].bookname,name)==0)
			{
				...
				cout<<"            " <<"\"Book ID\""<<"            " <<"\"Book Name\""<<"            " <<"\"Author Name\""<<"            " <<"\"Category\""<<"            " <<"\"Publication\""<<"            " <<"\"Month of Publication\""<<"            " <<"\"Year of Publication\""<<endl;
				cout<<"__________"<<"__________________________________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<endl;
				cout<<"            " <<books[loc].bookid<<"            " <<books[loc].bookname<<"            " <<books[loc].authorname<<"            " <<books[loc].bookcategory<<"            " <<books[loc].bookpubcom<<"            " <<books[loc].bookpubmonth<<"            " <<books[loc].bookpubyear<<endl;
				cout<<"__________"<<"__________________________________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<endl;	
			}
		}
		if(found == 0)
...
void sort(void)
{
	system("cls");
	   ...
	   cout <<"            "( 27 )<< "In Sort Function"<<endl
          ...
          << "            "( 40 ) << "( A ) Sort in Ascending Order" << endl << endl

          << "            "( 41 ) << "( D ) Sort in Descending Order" << endl << endl
...
void sortas(void)
{
	system("cls");
	   ...
	   cout <<"            "<< "In Sort Function"<<endl
          ...
          << "            " << "( N ) Sort by name" << endl << endl

          << "            " << "( I ) Sort by Id" << endl << endl
          
          << "            " << "( T ) Sort by author name" << endl << endl

          << "            " << "( C ) Sort by Category" << endl << endl

          << "            " << "( P ) Sort by Publication Company" << endl << endl

          << "            " << "( Y ) Sort by Publication Year" << endl << endl
...
void del(void)
	{
	   ...
	   cout <<"            "<< "In Delete Function"<<endl
          ...
          << "            " << "( N ) Delete by name" << endl << endl

          << "            " << "( I ) Delete by Id" << endl << endl
          
          << "            " << "( T ) Delete by author name" << endl << endl

          << "            " << "( C ) Delete by Category" << endl << endl

          << "            " << "( P ) Delete by Publication Company" << endl << endl

          << "            " << "( Y ) Delete by Publication Year" << endl << endl
...
void modify(void)
	{
	   ...
	   cout <<"            "<< "In Modify Function"<<endl
          ...
          << "            "<< "( N ) Modify by name" << endl << endl

          << "            " << "( I ) Modify by Id" << endl << endl
          
          << "            " << "( T ) Modify by author name" << endl << endl

          << "            " << "( C ) Modify by Category" << endl << endl

          << "            "( 46 ) << "( P ) Modify by Publication Company" << endl << endl

          << "            "<< "( Y ) Modify by Publication Year" << endl << endl
